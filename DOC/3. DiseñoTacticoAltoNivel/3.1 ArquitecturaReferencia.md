...
| **MSAL / Office 365 (Microsoft Entra ID)** | La universidad ya opera Office 365 institucionalmente — aprovechar ese SSO existente evita mantener un sistema de autenticación propio y sus riesgos asociados. |
